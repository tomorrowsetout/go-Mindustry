...
func classifyTurretBlockSyncKind(name string, prof buildingWeaponProfile) blockSyncKind {
	if prof.BlockSyncKind != blockSyncNone {
		return prof.BlockSyncKind
	}
	return classifyTurretBlockSyncKindSlow(name, prof)
}

func classifyTurretBlockSyncKindSlow(name string, prof buildingWeaponProfile) blockSyncKind {
